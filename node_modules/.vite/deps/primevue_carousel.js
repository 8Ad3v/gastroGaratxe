  ...
  computed: {
    ...
    defaultPT: function defaultPT() {
      ...
      return this._getPT((_this$$primevueConfig5 = this.$primevueConfig) === null || _this$$primevueConfig5 === void 0 ? void 0 : _this$$primevueConfig5.pt, void 0, function(value2) {
        return _this5._getOptionValue(value2, _this5.$name, _objectSpread({}, _this5.$params)) || resolve(value2, _objectSpread({}, _this5.$params));
      });
    },
...
var script10 = {
  ...
  methods: {
    ...
    onRightKey: function onRightKey() {
      var indicators = _toConsumableArray3(find(this.$refs.indicatorContent, '[data-pc-section="indicator"]'));
    ...
    createStyle: function createStyle() {
      ...
      if (this.responsiveOptions && !this.isUnstyled) {
        var _responsiveOptions = _toConsumableArray3(this.responsiveOptions);
